...
namespace WinFormsKeplerEllipticOrbit1mar2024
{
    public partial class Form1 : Form
    {
        ...
        private void Calculate(double eccentricity)
        {
            ...
            var solver = new DifferentialEquationsSolver26feb2024<double>(new DifferentialEquationsKepler<double>(), Method.RK61 | Method.Sophisticated);
