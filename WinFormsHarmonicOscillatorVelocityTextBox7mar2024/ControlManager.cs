...
using LibraryHarmonicOscillatorVelocity7mar2024;
using OxyPlot;
using OxyPlot.Annotations;
using OxyPlot.Series;
using OxyPlot.WindowsForms;

namespace WinFormsHarmonicOscillatorVelocityTextBox7mar2024
{
    internal class ControlManager
    {
        ...
        public ControlManager()
        {
            ...
            label1.Text = "Solving a system of differential equations: Harmonic oscillator"; // using displacement and velocity.";
        ...
        private void Calculate()
        {
            ...
            var problem = new DifferentialEquationsHarmonicOscillator7mar2024<double>(spring_configuration: spring_configuration, mass_configuration: mass_configuration);
