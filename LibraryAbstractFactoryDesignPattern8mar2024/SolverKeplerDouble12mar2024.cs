...
{
    public class SolverKeplerDouble12mar2024 : SolverKepler12mar2024, ISolverDouble12mar2024
    {
        ...
        public SolverKeplerDouble12mar2024(Method method)
        {
            var kepler = new DifferentialEquationsKepler<double>();
            solver = new DifferentialEquationsSolver26feb2024<double>(kepler, method);
        }
