...
{
    public class SolverKeplerFloat12mar2024 : SolverKepler12mar2024, ISolverFloat12mar2024
    {
        ...
        public SolverKeplerFloat12mar2024(Method method)
        {
            var kepler = new DifferentialEquationsKepler<float>();
            solver = new DifferentialEquationsSolver26feb2024<float>(kepler, method);
        }
