...
{
    public class DifferentialEquation3Float : DifferentialEquationBaseClass26feb2024<float>
    {
        private MassExoplanetManagerFloat mass_exoplanet_manager;
        private MassStarManagerFloat mass_star_manager;

        public DifferentialEquation3Float(MassExoplanetManagerFloat mass_exoplanet_manager, MassStarManagerFloat mass_star_manager, ParameterConfiguration mass_exoplanet_configuration = ParameterConfiguration.Constant, ParameterConfiguration mass_star_configuration = ParameterConfiguration.Constant)
        {
        ...
        public override float function(float interval, float x, params float[] y)
        {
            ...
            return (float)(-(y[0] * mass * Mass) / Math.Pow(y[0] * y[0] + y[1] * y[1], 1.5));
        }
    }
}
