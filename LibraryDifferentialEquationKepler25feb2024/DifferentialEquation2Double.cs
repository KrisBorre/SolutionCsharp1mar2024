...
{
    public class DifferentialEquation2Double : DifferentialEquationBaseClass26feb2024<double>
    {
        private MassExoplanetManagerDouble mass_exoplanet_manager;
        private MassStarManagerDouble mass_star_manager;

        public DifferentialEquation2Double(MassExoplanetManagerDouble mass_exoplanet_manager, MassStarManagerDouble mass_star_manager, ParameterConfiguration mass_exoplanet_configuration = ParameterConfiguration.Constant, ParameterConfiguration mass_star_configuration = ParameterConfiguration.Constant)
        {
