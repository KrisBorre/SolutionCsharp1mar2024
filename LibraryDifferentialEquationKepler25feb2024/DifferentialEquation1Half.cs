...
{
    public class DifferentialEquation1Half : DifferentialEquationBaseClass26feb2024<Half>
    {
        private MassExoplanetManagerHalf mass_exoplanet_manager;
        private MassStarManagerHalf mass_star_manager;

        public DifferentialEquation1Half(MassExoplanetManagerHalf mass_exoplanet_manager,
