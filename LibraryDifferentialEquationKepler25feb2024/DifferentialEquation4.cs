...
{
    public class DifferentialEquation4 : DifferentialEquation3Double
    {
        public DifferentialEquation4(MassExoplanetManagerDouble mass_exoplanet_manager, MassStarManagerDouble mass_star_manager,
