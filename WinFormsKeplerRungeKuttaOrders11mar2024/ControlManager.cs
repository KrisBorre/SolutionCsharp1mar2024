...
As the stepsize decreases the numerical error gets smaller until it reaches machine-epsilon using crude Runge-Kutta.
...
Reference: Numerical methods for ODEs, Butcher(2008)
           */
            ...
            var solver1 = new DifferentialEquationsSolver26feb2024<double>(kepler, Method.Euler | Method.Crude);
            var solver2 = new DifferentialEquationsSolver26feb2024<double>(kepler, Method.RK21 | Method.Crude);
            var solver3 = new DifferentialEquationsSolver26feb2024<double>(kepler, Method.RK31 | Method.Crude);
            var solver4 = new DifferentialEquationsSolver26feb2024<double>(kepler, Method.RK41 | Method.Crude);
            var solver5 = new DifferentialEquationsSolver26feb2024<double>(kepler, Method.RK5 | Method.Crude);
            var solver6 = new DifferentialEquationsSolver26feb2024<double>(kepler, Method.RK61 | Method.Crude);
            var solver7 = new DifferentialEquationsSolver26feb2024<double>(kepler, Method.RKCV8 | Method.Crude);
