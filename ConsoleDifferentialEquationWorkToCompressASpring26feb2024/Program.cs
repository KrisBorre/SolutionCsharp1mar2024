...
namespace ConsoleDifferentialEquationWorkToCompressASpring26feb2024
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("Using double precision floating point numbers");
            Console.WriteLine("Calculating the work (energy) required to compress a spring using a Runge-Kutta solver.");

            DifferentialEquationsSolverBaseClass26feb2024<double> solver = new DifferentialEquationsSolverEuler26feb2024<double>(new DifferentialEquationsWorkToCompressASpring());
            ...
            ConditionInitial26feb2024<double> ic = new ConditionInitial26feb2024<double>(a, 0); // W(a) = 0
            ...
            Console.WriteLine(solution.Y[0]); // 6.24375
