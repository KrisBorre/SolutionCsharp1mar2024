...
using LibraryHarmonicOscillatorMomentum6mar2024;
using OxyPlot;
using OxyPlot.Annotations;
using OxyPlot.Series;
using OxyPlot.WindowsForms;

namespace WinFormsHarmonicOscillatorMomentumTextBox6mar2024
{
    internal class ControlManager
    {
        ...
        public ControlManager()
        {
            ...
            label1.Text = "Solving a system of differential equations: Harmonic oscillator.";// using displacement and impuls momentum.";
        ...
        private void Calculate()
        {
            ...
            var problem = new DifferentialEquationsHarmonicOscillator6mar2024<double>(spring_configuration: spring_configuration, mass_configuration: mass_configuration);
