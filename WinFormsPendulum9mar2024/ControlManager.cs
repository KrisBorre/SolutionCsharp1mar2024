...
namespace WinFormsPendulum9mar2024
{
    internal class ControlManager
    {
        ...
        public ControlManager()
        {
            ...
            this.comboBoxGravity = new ComboBox();
            this.comboBoxLength = new ComboBox();
            ...
            this.comboBoxGravity.Location = new Point(225, 12);
            this.comboBoxGravity.Name = "comboBoxGravity";
            this.comboBoxGravity.Size = new Size(113, 23);
            this.comboBoxGravity.TabIndex = 3;
            ...
            this.comboBoxLength.Location = new Point(770, 12);
            this.comboBoxLength.Name = "comboBoxLength";
            this.comboBoxLength.Size = new Size(113, 23);
            this.comboBoxLength.TabIndex = 7;
            ...
            this.comboBoxMass.Location = new Point(454, 12);
            this.comboBoxMass.Name = "comboBoxMass";
            this.comboBoxMass.Size = new Size(113, 23);
            this.comboBoxMass.TabIndex = 5;

            this.controls.Add(label4);
            this.controls.Add(label3);
            this.controls.Add(label5);
            this.controls.Add(comboBoxLength);
            this.controls.Add(comboBoxGravity);
            this.controls.Add(comboBoxMass);
        ...
        private void Calculate()
        {
            ...
            if (this.comboBoxGravity.SelectedIndex == 1)
            {
                gravity_configuration = ParameterConfiguration.Decrease;
            }
            else if (this.comboBoxGravity.SelectedIndex == 2)
            {
            ...
            if (this.comboBoxLength.SelectedIndex == 1)
            {
                length_configuration = ParameterConfiguration.Decrease;
            }
            else if (this.comboBoxLength.SelectedIndex == 2)
            {
            ...
            var problem = new DifferentialEquationsPendulum8mar2024<double>(gravity_configuration: gravity_configuration, length_configuration: length_configuration, mass_configuration: mass_configuration);
