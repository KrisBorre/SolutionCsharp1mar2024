...
namespace WinFormsKeplerCrude25feb2024
{
...
Reference: Numerical methods for ODEs, Butcher(2008)
           */
            ...
            Text = "Sophisticated Runge-Kutta versus crude Runge-Kutta for Kepler's elliptic planetary motion (using double precision floating points)";
            ...
            ulong number_of_steps = 200; // 1; // Starting with 1 step will result in a "false" start in the fourth order behavior of RK.
            ...
            for (int k = 0; k < kmax; k++)
            {
                ...
                solver1.Solve(interval: interval, x_end: x_end, initialCondition: ic, number_of_steps: number_of_steps, delta_x: out double delta_x, out NumericalSolution26feb2024<double> solutionSophisticated);
                solver2.Solve(interval: interval, x_end: x_end, initialCondition: ic, number_of_steps: number_of_steps, delta_x: out double delta_x_crude, out NumericalSolution26feb2024<double> solutionCrude);
