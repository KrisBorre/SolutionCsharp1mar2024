...
Reference: Numerical methods for ODEs, Butcher(2008)
           */
            ...
            for (int k = 0; k < kmax; k++)
            {
                ...
                solver1.Solve(interval: (double)interval, x_end: (double)x_end, initialCondition: ic, number_of_steps: number_of_steps, delta_x: out double delta_x, out NumericalSolution26feb2024<double> solutionSophisticated);
                solver2.Solve(interval: (double)interval, x_end: (double)x_end, initialCondition: ic, number_of_steps: number_of_steps, delta_x: out double delta_x_crude, out NumericalSolution26feb2024<double> solutionCrude);
